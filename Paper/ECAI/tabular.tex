...
Therefore, the size of the blocks in the spreadsheet influences the runtime of these constraints.
For a block of size~$m$ there are $\frac{m(m + 1)}{2} = O(m^2)$ subblocks, thus, if a spreadsheet has smaller sized blocks, the search for aggregate constraints will be faster.
