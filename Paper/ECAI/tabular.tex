...
\caption{
  ...
  $\discrete(x)$ is a shortcut for: $\textual(x) \lor \numeric(x)$.  \luc{there are some fancy constraints here. it might be good to say something about them ... like an example of one of the more complex ones in the text ... maybe state what conditional means, what aggregate ... }
}
