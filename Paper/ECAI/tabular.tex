...
However, in practice, for very small blocks to the superblock assignment phase has to generate a very large number of combinations, while for larger blocks this work is done mostly during the subassignment generation phase.
Since this last phase is more adept at generating these combinations, shifting this workload to the assignment phase slows down the algorithm.
