...
\end{itemize}
\noindent
{\bf Find}  the set of all constraints $s(G_1', ..., G_n')$ that 1) are satisfied  in ${\cal T}$, 2)
for which all $G_i' \subseteq G_i \in {\cal G}$ and  3) the groups $G_1', ... , G_n'$ satisfy the signature of the constraint template~$s \in {\cal C}$.
