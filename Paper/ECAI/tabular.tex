...
The benchmark experiments show that the number of cells in a spreadsheet only has a limited effect on the runtime.
Since the implementation is tailored to fail fast when testing constraints, the runtime is in practice 
