...
\begin{figure*}[thb]
  ...
  \end{center}
  \vspace{-10pt}
  \caption{Example spreadsheet (black words and numbers only). Green borders indicate headerless tables; the blue elements are added to clarify some constraints and relations. \tias{Use specific constraint names, e.g. 'SUM-row' above Total in T1}}
...
%
    ...
    \end{align*}}
  \vspace{-10pt}
  \caption{Constraints present in the running example (left), except \textit{ALLDIFFERENT} (16) and \textit{FOREIGNKEY} (5).\samuel{Not the desired constraints ask : \tias{}}}
