...
Since our implementation tries to account for this by failing fast, the amortized time is constant in the size of the vectors~$k$, unless $k$~is very large or many constraints hold in the data.
...
Synthetic experiments with random integers and strings show that increasing the size of the vectors has a neglegible impact on the performance.
