...
\begin{figure*}[thb]
  ...
  \end{center}
  \vspace{-10pt}
  \caption{Example spreadsheet (black words and numbers only). Blue and green elements are added by us to clarify the relations. \tias{TODO: headers not in green boxes}}
