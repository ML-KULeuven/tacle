...
Moreover, among the semantically equivalent constraints product (\ecprod{B_R'}{B_1'}{B_2'}) and division (\eccalc{B_1'}{B_R' / B_2'}) we only added division, as well as only difference (\ecdiff{B_r}{B_1}{B_2}) and not sum (\eccalc{B_1}{B_r + B_2}). However, division and sum could easily be added, as could it be added explicitly in post-processing based on the matching product and difference constraints.
...
\tias{This would be a good place to say that for aggregates, you do SUBASSIGNMENTS with specialised code...}
...
Constraints that are currently outside of the scope of this system, e.g. generic nested mathematical or logical formulas and date-related constraints, are ignored.
