...
Moreover, the system could be adapted to deal with additional types and produce less redundant constraints through the use of (heuristic) filtering or post-processing.
...
This shift would bring the approach closer towards programming by example.
