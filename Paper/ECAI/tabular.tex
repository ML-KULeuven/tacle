...
\title{Discovering constraints in spreadsheets and tabular data}
...
Common spreadsheet formulas are represented as predicates whose arguments must satisfy the inherent properties of the function. The challenge is to discover these without user information or training examples. % Knowledge discovery
...
Our approach to this knowledge discovery task takes inspiration from inductive logic programming, constraint learning and constraint satisfaction.
...
% why difficult
In this paper,  we investigate whether knowledge discovery techniques can be used to learn constraints (formulas and other relations) in spreadsheet data in an unsupervised way.
