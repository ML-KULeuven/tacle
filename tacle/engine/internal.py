...
class InternalCSPStrategy(AssignmentStrategy):
    ...
    def apply(self, constraint: ConstraintTemplate, groups: [Group], target_group, solutions):
        return constraint.source.candidates(groups,  target_group, solutions, constraint.filters)
