...
class Aggregate(ConstraintTemplate):
    ...
    y = Variable("Y", vector=True, types=numeric, prime=True)
...
class AllDifferent(ConstraintTemplate):
    x = Variable("X", types=discrete, prime=True)
...
class Ordered(ConstraintTemplate):
    x = Variable("X", types=numeric, prime=True)
...
class Rank(ConstraintTemplate):
    ...
    y = Variable("Y", vector=True, types=integer, prime=True)
...
class VectorOperation(ConstraintTemplate):
    result = Variable("R", vector=True, types=numeric, prime=True)
...
class Equal(ConstraintTemplate):
    first = Variable("O1", vector=True, prime=True)
